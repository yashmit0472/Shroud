...
type SearchConfig<Value = string> = {
    ...
    source: (term: string | undefined, opt: {
        signal: AbortSignal;
    }) => ReadonlyArray<Value | Choice<Value> | Separator> | Promise<ReadonlyArray<Value | Choice<Value> | Separator>>;
...
} & SearchConfig<Value>, context?: import("@inquirer/type").Context) => Promise<Value>;
