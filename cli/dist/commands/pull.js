...
import { getProjects, getEnvironments, getSecrets, getSecretValue, } from "../lib/api.js";
...
export const pullCommand = new Command("pull")
    ...
    try {
        ...
        console.log(`Successfully pulled ${values.length} environment variables into .env`);
    }
    catch (error) {
